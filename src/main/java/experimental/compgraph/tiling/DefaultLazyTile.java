...
public class DefaultLazyTile<T> extends AbstractInterval implements LazyTile<T> {

	// TODO: this is where we do threading
	// TODO: partial tiles have to be handled here!

	public DefaultLazyTile(final RandomAccessibleInterval<T> source, final Tile interval) {
		super(interval);
	}
