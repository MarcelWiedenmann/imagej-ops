...
/**
 * Code mainly stolen from net.imagej.ops.filter.gauss.DefaultGaussRAI by
 * Christian Dietz, University of Konstanz. For the sake of easy demonstration
 * of tiled operations w/o any own effort :D
 */
    ...
    TilableNeighborhoodOp
{
    ...
    public void compute1(final RandomAccessibleInterval<T> input, final RandomAccessibleInterval<T> output)
    {
        ...
        try
        {
            SeparableSymmetricConvolution.convolve(Gauss3.halfkernels(sigmas), eIn, output, threads
                .getExecutorService());
        }
